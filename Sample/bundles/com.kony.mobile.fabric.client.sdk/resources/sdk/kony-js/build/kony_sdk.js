...
kony.sdk.addDefaultHeaders = function(headers) {
    ...
    if(!headers.hasOwnProperty(kony.sdk.constants.REQUEST_ID_HEADER)) {
        if(kony.sdk.isNullOrUndefined(kony.sdk.currentInstance)) {
            ...
            var sessionId = kony.sdk.currentInstance.getSessionId();
            if(kony.sdk.isNullOrUndefined(sessionId) || kony.sdk.isEmptyObject(sessionId)) {
                sessionId = kony.license.generateUUID().toString();
            }
            headers[kony.sdk.constants.REQUEST_ID_HEADER] = sessionId;
        }
    }
    return headers;
};
...
kony.sdk.util.getSessionURLfromAppConfig = function() {
    if(kony.sdk.isNullOrUndefined(appConfig) || kony.sdk.isNullOrUndefined(appConfig.svcDoc)
    || kony.sdk.isNullOrUndefined(appConfig.svcDoc.reportingsvc) ||
        kony.sdk.isNullOrUndefined(appConfig.svcDoc.reportingsvc.session)){
        return null;
    }
